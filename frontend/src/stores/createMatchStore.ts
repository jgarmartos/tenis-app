...
export const useCreateMatchStore = defineStore('createMatch', {
  ...
  actions: {
    ...
    createAndSaveSets(matchSubmit: MatchSubmit, matchId: number) {
      ...
      matchSubmit.winner =
        this.matchScore.score1 > this.matchScore.score2
          ? this.selectedPlayer1.id
          : this.matchScore.score1 < this.matchScore.score2
            ? this.selectedPlayer2.id
            : null;
    ...
    createAndSaveGames(
      ...
      if (type === 'Set') {
        games.forEach((game, index) => {
          if (game.selectedPuntuation1 === 0 && game.selectedPuntuation2 === 0)
            return;
          ...
          const submitGame: GameSubmit = {
            ...
            scorePlayer1:
              game.selectedPuntuation1 == 50
                ? 'AD'
                : game.selectedPuntuation1.toString(),
            scorePlayer2:
              game.selectedPuntuation2 == 50
                ? 'AD'
                : game.selectedPuntuation2.toString(),
            pointsPlayer1:
              index === 12
                ? game.selectedPuntuation1
                : game.selectedPuntuation1 == 15
                  ? 1
                  : game.selectedPuntuation1 == 30
                    ? 2
            ...
            pointsPlayer2:
              index === 12
                ...
                : game.selectedPuntuation2 == 15
                  ? 1
                  : game.selectedPuntuation2 == 30
                    ? 2
          ...
          if (game.deuceNumber !== 0) {
            submitGame.pointsPlayer1 =
              submitGame.pointsPlayer1 + game.deuceNumber - 1;
            submitGame.pointsPlayer2 =
              submitGame.pointsPlayer2 + game.deuceNumber - 1;
          }
